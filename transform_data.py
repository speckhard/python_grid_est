...
This module contains methods to change the voltage magnitude data so that the
resulting data-use results in an improved estimation. 
"""

import numpy as np

def take_deriv(vmag_matrix, deriv_step):
        
    """ Convert data voltage mag. data into change 
